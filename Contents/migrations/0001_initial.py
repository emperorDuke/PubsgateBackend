...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ManuscriptSubSection',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('level', models.IntegerField(choices=[(1, 'Level 1'), (2, 'Level 2'), (3, 'Level 3'), (4, 'Level 4'), (5, 'Level 5')], default=1, verbose_name='level')),
                ('heading', models.CharField(max_length=255, verbose_name='heading')),
                ('body', models.TextField(verbose_name='body')),
                ('parent_id', models.UUIDField(blank=True, null=True, verbose_name='parent_id')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created_at')),
                ('manuscript_section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sub_sections', to='Contents.manuscriptsection')),
            ],
            options={
                'verbose_name': 'manuscript_sub_section',
                'verbose_name_plural': 'manuscript_sub_sections',
        ...
        migrations.AddConstraint(
            model_name='manuscriptsubsection',
            constraint=models.UniqueConstraint(fields=('manuscript_section', 'heading'), name='unique_heading'),
        ),
        migrations.AddConstraint(
