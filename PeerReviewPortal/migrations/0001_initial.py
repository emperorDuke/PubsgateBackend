    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_submission', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='SubmissionPortal.authorsubmission')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('report', 'editor', 'journal_submission'), name='unique_editor_report'),
        ),
    ]
